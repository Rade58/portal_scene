...
// we will send one multiplier that determines the size
// of the particles (among other things like pixel ratio and size attenuation)

// we will name it uSize and we will change it with gui
