...
// this might not be the issue for you in this exmaple
// but you may not see gradient, you may see just uniform color
// This means that for portal, your uv isn't unwrapped properly

// If you are using blender, you can try to unwrap the uv
// properly

// In our project we didn't unwrap the uv for portal mesh
// but we included portal to be part of the scene

// to check if portatl isn't unwrapped properly
// go to blender into uv editing mode

// select portal and go to edit mode
// you should notice in uv editor that the
// portal cicrcle looks blue

// if it looks blue, then it is unwrapped properly

// if not we need to unwrap it properly

// it might be that your portal is invisible, or
// it isn't blue in uv editor

// or it's missing in uv editor

// if you don't see it just select all the faces
// you press U and select unwrap
//

// this can maybe happen if you created mesh but you didn't
// check the box for generate uv's

// when you make a fix you need to export the model again
// and overwrite the old one in our case it is scene.glb in models/portal
