...
// we are talking about meshes from our model we didn't
// make representation in our texture since they need to emit light
// and it looks like they are emitting light since other texture
// representations have that light emmited on them as a part of texture

// we will replace materials for them with MeshBasicMaterial instances
// instead of MeshStandardMaterial

// we will have two instances of MeshBasicMaterial, for pole lamps and for portal

// how we know to which mesh we should apply which material?
// well, when traversing through the model we can check the name
// of the mesh
// and I think we was good with naming our meshes in blender

// if not satisfied with the names you can always place
// another name in blender for the meshes we need to name and
// reexport the model and use new model in three.js instead of the
// current one
