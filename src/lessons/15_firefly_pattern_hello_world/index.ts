...
// increase the particle size to 200

// show uv coordinates with gl_PointCoord (in the fragment shader)

// gl_PointCoord is already available in the fragment shader (a vec2)

// this will be the starting point pattern (look in fragment shader)
