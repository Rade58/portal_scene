...
// We are just going to search for emission meshes with find method
// to apply different materials to them
// (same thing we did in previous lesson, just with find method)
// we are using this method on `children` array of the model
